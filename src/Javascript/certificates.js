fetch('./Data/certificates.json')
  ...
  .then(certificates => {
    ...
    certificates.forEach(cert => {
      const certHTML = `
        <div class="border text-sm lg:text-base rounded-xl shadow-md p-2 lg:p-4 text-center bg-white opacity-90 hover:shadow-lg duration-200 flex flex-col gap-2 justify-center items-center">
